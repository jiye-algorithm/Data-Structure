...
public:
	...
	// Postcondition: the list size increases by 1
	dnode<T> * insert(dnode<T> * pos, const T& item);
...
template <typename T>
dnode<T> *typrname miniList<T>::getDNode(const T& item)
{
...
template <typename T>
dnode<T> *typrname miniList<T>::dinsert(dnode<T> *curr, const T& item)
{
...
template <typename T>
void typrname miniList<T>::derase(dnode<T> *curr)
{
...
// list size is 0
template <typename T>
typrname miniList<T>::miniList() : listSize(0)
{
...
// list size is n
template <typename T>
typrname miniList<T>::miniList(int n, const T& value) : listSize(n)
{
	int i;
...
template <typename T>
typrname miniList<T>::miniList(T* first, T* last) : listSize(0)
{
	T *curr = first;
...
template <typename T>
typrname miniList<T>::miniList(const miniList<T>& obj) : listSize(obj.listSize)
{
...
template <typename T>
miniList<T>& typrname miniList<T>::operator=(const miniList<T>& rhs)
{
...
template <typename T>
int typrname miniList<T>::size() const
{
	return listSize;
}

template <typename T>
bool typrname miniList<T>::empty() const
{
	return listSize == 0;
}

template <typename T>
void typrname miniList<T>::push_front(const T& item)
{
	// insert at the front
...
template <typename T>
void typrname miniList<T>::push_back(const T& item)
{
	// insert at the back
	dinsert(header, item);
...
template <typename T>
typrname miniList<T>::dnode<T> * typrname miniList<T>::insert(dnode<T> * pos, const T& item)
{
	...
	// constructor converts newNode to an dnode<T> *
	return newNode;
}


template <typename T>
void typrname miniList<T>::pop_front()
{
	if (listSize == 0)
...
template <typename T>
void typrname miniList<T>::pop_back()
{
	if (listSize == 0)
...
template <typename T>
void typrname miniList<T>::erase(dnode<T> * pos)
{
	if (listSize == 0)
...
template <typename T>
const T& typrname miniList<T>::front() const
{
	if (listSize == 0)
		throw underflowError("miniList front(): list is empty");
...
template <typename T>
const T& typrname miniList<T>::back() const
{
	if (listSize == 0)
		throw underflowError("miniList back(): list is empty");
